function calc_Esti_FondCommerce() {
    ...
    if (radios != null) {
        document.getElementById("Resultat").innerHTML = "<div class=\"alert alert-danger m-3\" role=\"alert\"> Veuillez selectionner une zone d'activité</div>";
    }
    ...
    if (ville != "" && codePostal != "" && ca != "" && loyer != "") {
                ...
                if(ca>=0){
                    if(loyer>=0){
                        if (secteurActi != "null") {
                            ...
                            document.getElementById("Resultat").innerHTML = "<div class=\"alert alert-danger m-3\" role=\"alert\"> Vous n'avez pas sélectionné de secteur d'activité </div>";
                        }
                    }else{
                        messageErreur(loyer);    
                    }
        ...
        document.getElementById("Resultat").innerHTML = "<div class=\"alert alert-danger m-3\" role=\"alert\"> Veuillez remplir tous les champs </div>";
    }
}


function messageErreur(nom_input) {
    document.getElementById("Resultat").innerHTML = "<div class=\"alert alert-danger m-3\" role=\"alert\">" + nom_input + " est incorrect </div>";
}
